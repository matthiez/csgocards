<form id='set_timezone' action='{{route('userSetTimezone')}}' method='POST'>
    {{csrf_field()}}
    <div class="mdl-selectfield mdl-js-selectfield mdl-selectfield--floating-label">
        <select
                id="timezone" name='timezone' class="mdl-selectfield__select"
                title='Select timezone'
        >
            @if (empty($user['general']['timezone']))
                <option value="" disabled selected>Select your Timezone
                </option>
            @else
                <option
                        value="" disabled
                        selected
                >{{ App\Traits\Helper::timezoneLabel($user['general']['timezone']) }}</option>
            @endif
            ...
            <option value='America/Mexico_City'>(UTC-06:00) Mexico City
            </option>
            ...
            <option value='Canada/Atlantic'>(UTC-04:00) Atlantic Time
                (Canada)
            </option>
            ...
            <option value='Asia/Yekaterinburg'>(UTC+06:00) Ekaterinburg
            </option>
